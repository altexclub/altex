...
from test_framework.test_framework import ALTEXTestFramework
...
class LLMQCoinbaseCommitmentsTest(ALTEXTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as ALTEXTestFramework doesn't support this atm)
