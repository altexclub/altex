...
#define BOOST_TEST_MODULE ALTEX Test Suite

#include "test_altex.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_altex_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
