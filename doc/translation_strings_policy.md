...
This document provides guidelines for internationalization of the ALTEX Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `altex_en.ts` remains unchanged.
