...
* altex.conf: contains configuration settings for altexd or altex-qt
* altexd.pid: stores the process id of altexd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by altexd or altex-qt
