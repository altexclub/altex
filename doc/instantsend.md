...
This mechanism has been integrated into Bitcore-Node-ALTEX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/altexpay/insight-api-altex#web-socket-api](https://github.com/altexpay/insight-api-altex#web-socket-api)
* API: [https://github.com/altexpay/insight-api-altex#instantsend-transactions](https://github.com/altexpay/insight-api-altex#instantsend-transactions)
