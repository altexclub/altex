...
Arguments:
    <base_directory> - The base directory of a ALTEX Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The ALTEX Core developers'
...
Arguments:
    <base_directory> - The base directory of ALTEX Core source code repository.
"""
...
Arguments:
    <file> - A source file in the ALTEX Core repository.
"""
